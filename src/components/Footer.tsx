...
const Footer: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Footer Content */}
      <footer className="bg-white py-4 dark:bg-black border-t border-gray-200 dark:border-gray-800">
  <div className="max-w-screen-xl mx-auto px-4 md:flex md:items-center md:justify-between">
    ...
    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
      © {new Date().getFullYear()} Tamara Zawadi. All Rights Reserved.
    </span>

    {/* Icons positioned toward the right with a margin inset */}
    <div className="flex space-x-6 mt-4 md:mt-0 items-center md:mr-32">
      ...
      {/* LinkedIn */}
      <a 
        href="https://www.linkedin.com/in/tamara-zawadi/" 
        target="_blank" 
        rel="noopener noreferrer"
        className="text-gray-500 hover:text-green-500 dark:text-gray-400 dark:hover:text-green-400 transition-colors"
        aria-label="LinkedIn"
      ...
      {/* Email */}
      <a 
        href="mailto:tamarazawadi101@gmail.com" 
        className="text-gray-500 hover:text-green-500 dark:text-gray-400 dark:hover:text-green-400 transition-colors"
        aria-label="Email"
      >
